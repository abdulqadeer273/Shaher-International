export const Data = [
  ...
  },
  {
    ...
    videoSrc: "",
    heading: "Import Air Freight",
    text1:
      "From small individual consignments to large consolidations, we can provide you with a wide range of airfreight services from all major airports worldwide. We leep close contact with the airlines around the world to track your shipments. Our network of agents confirms all cargo delivery.",
    text2:
  ...
  },
  {
    imageSrc: "/lucas-van-oort-fBZOVyF-96w-unsplash_1.webp",
    videoSrc: "",
    heading: "Import Ocean Freight",
    text1:
      "The strategic partnershops we have set up with our associates and major ocean carriers bring you advantages in freight rates, eqiopment availability, space reservation ensuring your clients trust in your business.",
    text2:
